(function() {
    ...
    // MOBILE KEYBOARD FIX: Dynamically adjust height to viewport
    ...
    chatBtn.addEventListener('click', function() { 
        adjustForKeyboard(); // Set height immediately on open
        chatWindow.style.display = 'flex'; 
        chatBtn.style.display = 'none'; 
    });
    
    closeBtn.addEventListener('click', function() { 
        chatWindow.style.height = '100%'; // Reset on close
        chatWindow.style.display = 'none'; 
        chatBtn.style.display = 'flex'; 
    });

    // Backup fix: Force the browser to scroll the input into view
    ...
    async function sendMessage() {
        ...
        try {
            ...
            // Create empty message box for typewriter
