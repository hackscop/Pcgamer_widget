...
(function() {
    ...
    var widgetContainer = document.createElement('div');
    widgetContainer.innerHTML = '<button id="ai-chat-widget-btn"><svg width="26" height="26" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="monoGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#888" /><stop offset="50%" stop-color="#444" /><stop offset="100%" stop-color="#000" /></linearGradient></defs><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill="url(#monoGrad)"/><circle cx="12" cy="12" r="3.5" fill="url(#monoGrad)"/></svg><div id="ai-btn-text">Ask AI</div></button><div id="ai-chat-window"><div id="ai-chat-header"><button id="ai-chat-close">&#10094;</button><img id="ai-chat-logo" src="https://ui-avatars.com/api/?name=ES&background=fff&color=000&rounded=true" alt="Logo"><div id="ai-chat-title">ESGaming</div></div><div id="ai-chat-messages"><div class="msg-wrapper ai-wrapper"><div class="msg-label">ESGaming AI</div><div class="ai-msg">Hello! How can I help you build your ultimate setup today?</div></div></div><div id="ai-chat-input-area"><input type="text" id="ai-chat-input" placeholder="Type a message..."><button id="ai-chat-send"><svg viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"></path></svg></button></div></div>';
    document.body.appendChild(widgetContainer);
